...
describe('WCS API:', function () {
  ...
  describe('GET /api/WCS/', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/WCS/').expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        WCSs = res.body;
  ...
  describe('POST /api/WCS/', function () {
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).post('/api/WCS/').send({
        name: 'New WCS',
  ...
  describe('GET /api/WCS/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).get('/api/WCS/' + newWCS._id).expect(200).expect('Content-Type', /json/).end(function (err, res) {
        if (err) {
          return done(err);
        }
        WCS = res.body;
  ...
  describe('PUT /api/WCS/:id', function () {
    ...
    beforeEach(function (done) {
      (0, _supertest2['default'])(app).put('/api/WCS/' + newWCS._id).send({
        name: 'Updated WCS',
  ...
  describe('DELETE /api/WCS/:id', function () {
    ...
    it('should respond with 204 on successful removal', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/WCS/' + newWCS._id).expect(204).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
    ...
    it('should respond with 404 when WCS does not exist', function (done) {
      (0, _supertest2['default'])(app)['delete']('/api/WCS/' + newWCS._id).expect(404).end(function (err, res) {
        if (err) {
          return done(err);
        }
        done();
...
//# sourceMappingURL=WCS.integration.js.map
